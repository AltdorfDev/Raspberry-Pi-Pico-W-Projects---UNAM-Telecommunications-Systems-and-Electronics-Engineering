...
mqtt_channel_id = "XXXXXXX"  # Reemplaza con tu Channel ID
mqtt_publish_topic = f"channels/{mqtt_channel_id}/publish"
mqtt_client_id = "Dy8mOx02NDYXXXXXXXXXXXX"  # Client ID proporcionado
mqtt_username = "Dy8mOx02NDYsAXXXXXXXXXX"  # Username proporcionado
mqtt_password = "DiFOK8FwcUs7GwA4XXXXXXXX"  # Reemplaza con tu password completo
...
def connect_wifi():
    ...
    wlan.active(True)
    wlan.connect('XXXXXXXXXX', 'XXXXXXXXXX')  # Reemplaza con tus credenciales WiFi
